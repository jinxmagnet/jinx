import{_ as s,o as i,c as a,R as n}from"./chunks/framework.gdc2w2R7.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/backend/nginx/配置相关/1.默认配置.md","filePath":"articles/backend/nginx/配置相关/1.默认配置.md","lastUpdated":1703140300000}'),p={name:"articles/backend/nginx/配置相关/1.默认配置.md"},l=n(`<p>nginx默认配置文件</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">server</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> {</span></span>
